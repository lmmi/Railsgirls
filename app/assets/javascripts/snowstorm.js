...
function SnowStorm() {
  ...
  this.targetElement = document.getElementById('hed');      // element which snow will be appended to (document body if null/undefined) - can be an element ID string, or a DOM node reference
